...
💻o objetivo era mostrar como o computador toma decisões programadas utilizando if, elif, and, or e not.  
 ...
 linha 15 - transforma consumo_mensal para float(valor decimal) e transformando  para consumo_limpo, removendo a sigla m³, caso  eu escrevesse no valor (ex:"10.0m³">>>>"10.0");<br>
 linha 18 a 25 - usa o valor de imovel e consumo_limpo, junto de condições para  dizer o tipo de consumo e dizer uma mensagem;<br>
 linha 27 a 29 - usa  "except ValueError" junto do "try:" transformando  o erro do programa em uma mensagem.<br>  
